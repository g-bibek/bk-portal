...
export class ResourceResolverBase {
  ...
  async createResource(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        parentResource: args.data.parentResource
          ? {
              connect: args.data.parentResource,
            }
          : undefined,
      },
    });
  ...
  async childResources(
    ...
    const results = await this.service.findChildResources(parent.id, args);
  ...
  async empowerments(
    ...
    const results = await this.service.findEmpowerments(parent.id, args);
  ...
  async mahakramas(
    ...
    const results = await this.service.findMahakramas(parent.id, args);
  ...
  async parentResource(
    ...
    const result = await this.service.getParentResource(parent.id);
