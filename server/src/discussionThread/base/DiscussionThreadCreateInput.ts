...
@InputType()
class DiscussionThreadCreateInput {
  @ApiProperty({
    required: false,
    type: () => DiscussionThreadCreateNestedManyWithoutDiscussionThreadsInput,
  })
  @ValidateNested()
  @Type(() => DiscussionThreadCreateNestedManyWithoutDiscussionThreadsInput)
  @IsOptional()
  @Field(() => DiscussionThreadCreateNestedManyWithoutDiscussionThreadsInput, {
    nullable: true,
  })
...
export { DiscussionThreadCreateInput };
